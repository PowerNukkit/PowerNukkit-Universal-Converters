 ...
 * @since 2020-11-18
 */
interface LevelDBWriteContainer {
    operator fun set(key: ByteArray, value: ByteArray)
    fun delete(key: ByteArray)

    operator fun set(key: String, value: ByteArray) = set(key.toByteArray(), value)
    operator fun set(key: ByteArray, value: String) = set(key, value.toByteArray())
